      ...
      <div className="bg-white rounded-[24px] p-6 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] border border-[#e0e0e0] space-y-6 w-full">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto">
            <Select value={filterDiretoria} onValueChange={(v) => { setFilterDiretoria(v); setFilterArea("all"); setPage(1); }}>
            ...
            <Select value={filterStatus} onValueChange={(v) => { setFilterStatus(v); setPage(1); }}>
              <SelectTrigger className="w-full md:w-[160px] h-10 rounded-full font-normal">
